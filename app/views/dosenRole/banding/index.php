                    ...
                    foreach ($data['bd'] as $banding) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= BASEURL; ?>/DosenControllers/banding/hapus/<?= $banding['id_banding']; ?>" class="badge bg-danger float-right" onclick="return confirm('Apakah Anda yakin untuk menghapus Data Banding berikut?');">hapus</a>
                            </td>
                        </tr>
                <?php endforeach;
                endif; ?>
