<div class="container mt-3">
    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            <form action="<?= BASEURL; ?>DosenControllers/banding/cari" method="post">
                ...
                if (empty($data['bd'])) : ?>
                    ...
                    foreach ($data['bd'] as $banding) : ?>
                        <tr>
                            ...
                            <?php endif; ?>
                            <td>
                                <a href="<?= BASEURL; ?>/DosenControllers/banding/detail/<?= $banding['id_banding']; ?>" class="badge bg-success float-right tampilModalDetailBanding" data-bs-toggle="modal" data-bs-target="#detailModalBanding" data-id_banding="<?= $banding['id_banding']; ?>">detail</a>
                                <a href="<?= BASEURL; ?>/DosenControllers/banding/hapus/<?= $banding['id_banding']; ?>" class="badge bg-danger float-right" onclick="return confirmAction()">hapus</a>
                                <script>
                                    function confirmAction() {
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                window.location.href = "<?= BASEURL; ?>/DosenControllers/banding/hapus/<?= $banding['id_banding']; ?>";
                                            }
                                        });
