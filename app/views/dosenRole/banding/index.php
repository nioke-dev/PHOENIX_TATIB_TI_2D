                ...
                foreach ($data['bd'] as $banding) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= BASEURL; ?>/DosenControllers/banding/setujuBanding/<?= $banding['id_banding']; ?>" class="badge bg-success float-right" data-bs-toggle="modal" data-bs-target="#detailModalBanding" data-id_banding="<?= $banding['id_banding']; ?>">Setuju</a>
                            <a href="<?= BASEURL; ?>/DosenControllers/banding/tolakBanding/<?= $banding['id_banding']; ?>" class="badge bg-danger float-right" data-bs-toggle="modal" data-bs-target="#detailModalBanding" data-id_banding="<?= $banding['id_banding']; ?>">Tolak</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
