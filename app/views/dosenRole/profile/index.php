<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Profile Dosen</h6>
    </div>
    <!-- Card Body -->
    <div class="card-body">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-6 mb-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nip_dosen" id="nip_dosen" value="<?= $data['dsn']['nip_dosen']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-6 mb-5">
                            <div class="form-group">
                                <label for="nama_dosen" class="form-label">Nama :</label>
                                <input type="text" class="form-control" name="nama_dosen" id="nama_dosen" value="<?= $data['dsn']['nama_dosen']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-6 mb-5">
                            <div class="form-group">
                                <label for="email_dosen" class="form-label">Email :</label>
                                <input type="text" class="form-control" name="email_dosen" id="email_dosen" value="<?= $data['dsn']['email_dosen']; ?>" readonly>
                            </div>
                        </div>
