<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h4 class="m-0 font-weight-bold text-dark">Daftar Laporan Mahasiswa</h4>
    </div>
    <!-- Card Body -->
    <div class="card-body">
        <div class="row">
                    ...
                    <tbody>
                        ...
                        foreach ($data['laporan'] as $laporan) : ?>
                            <tr>
                                ...
                                <?php elseif ($laporan['status_sanksi'] == 'Disetujui') : ?>
                                ...
                                <?php endif; ?>
                                <td>
                                    <a href="<?= BASEURL; ?>/DpaControllers/rekapLaporan/detail/<?= $laporan['id_laporan']; ?>" class="badge bg-primary tampilModalDetailLaporanDpaRole" data-bs-toggle="modal" data-bs-target="#detailModalLaporan" data-id_laporan="<?= $laporan['id_laporan']; ?>">Detail</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
