                        ...
                        foreach ($data['bd'] as $banding) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($banding['status_sanksi']  ==  'Baru') :  ?>
                                        <a href="<?= BASEURL; ?>/MahasiswaControllers/banding/hapus/<?= $banding['id_banding']; ?>" class="badge bg-danger float-right" onclick="return confirmAction('<?= BASEURL; ?>/MahasiswaControllers/banding/hapus/<?= $banding['id_banding']; ?>')">Hapus</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
