<div class="container mt-3">
    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            <form action="<?= BASEURL; ?>/banding/cari" method="post">
                    ...
                    <tr>
                        ...
                        <?php if($banding['status_sanksi'] == 'Diterima') : ?>
                            ...
                            <?php elseif($banding['status_sanksi'] == 'Ditolak') : ?>
                                ...
                                <?php endif; ?>
                            <td>
                            <a href="<?= BASEURL; ?>/banding/detail/<?= $banding['id_banding']; ?>" class="badge bg-success float-right tampilModalDetailBanding" data-bs-toggle="modal" data-bs-target="#detailModalBanding" data-id_banding="<?= $banding['id_banding']; ?>">detail</a>
                        </td>
                    </tr>
                <?php endforeach; 
                endif; ?>
