...
<div class="py-6 px-6 text-center bg-light">
    <p class="mb-0 fs-4">Design and Developed by <a href="https://www.nioke-studio.my.id/" target="_blank" class="pe-1 text-primary text-decoration-underline">Nioke Studio</a> Distributed by <a href="https://themewagon.com">Nioke Corporation</a></p>
</div>
</div>
</div>
<!-- old -->
